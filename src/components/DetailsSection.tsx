...
const details = [
  { icon: Calendar, label: "Date", value: "13 March", sub: "Event Date" },
  { icon: MapPin, label: "Venue", value: "Offline", sub: "SNS College of Engineering" },
  { icon: Users, label: "Team Size", value: "1 – 4 Members", sub: "Per team" },
  { icon: Clock, label: "Time", value: "9:30 AM – 1:00 PM", sub: "Event duration" },
];
